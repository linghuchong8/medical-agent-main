...
async def test_supervisor_agent():
    result = await chat_endpoint("1234", new_session(), "你好，我是雷丰阳")
    print(result)
...
async def test_agent_memory():
    ...
    # 第一轮：自我介绍
    s = new_session()
    reply1 = await chat_endpoint("1123", s, "你好，我叫雷丰阳")
    print(f"\n第一轮回复：{reply1}")

    # 第二轮：考察记忆
    reply2 = await chat_endpoint("1123", s, "我是谁？")
    ...
    # 第三轮：新会话
    reply3 = await chat_endpoint("1123", new_session(), "我是谁？")
...
async def test_agent_store():
    ...
    assert "新冠" in resp2, f"长期记忆应能跨会话检索到新冠病史，实际回复：{resp2}"
